...
namespace DAL
{
    class Dal_XML : Idal
    {
        ...
        public string ConvertMetrix(bool[] UserMetrix)
        {

            {
                ...
                if (UserMetrix != null)
                {
                    ...
                    for (int i = 0; i < sizeA; i++)
                            ...
                            result += "," + ToXMLstring(UserMetrix[i]);
                }
                return result;
            }
        }
        public string ConvertMetrix(DateTime[,] UserMetrix)
        {
        ...
        //public  DateTime [,] ConvertMetrix (string value)
        ...
        //           UserMetrix = new DateTime [sizeA, sizeB];

        //            int index = 2;

        //            for (int i = 0; i < sizeA; i++)
        //                for (int j = 0; j < sizeB; j++)
        //                    UserMetrix[i, j] = ToObject<DateTime>(values[index++]);
        //        }
        //    return UserMetrix ; 
        //}
        ...
        Nanny ConvertNanny(XElement element)
        {
            ...
            ConvertMetrix(nanny.HoursWorking);
